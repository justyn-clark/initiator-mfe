var cookieMap;
// Cookies
MFE.utils.getCookies = update => { // Get cookies
  if(!cookieMap || update) {
    cookieMap = {};
...
MFE.utils.getCookie = (c, update) => { // Get cookie
  return this.getCookies(update)[c];
};

MFE.utils.setCookie = (name, value, opts) => { // Set cookie MFE.utils.setCookie('jcCookie',true, {expireDate: (3600 * 24 * 365)});
